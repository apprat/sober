...
const svgData = {
  ...
  circle_fill: 'M480-200q-117 0-198.5-81.5T200-480q0-117 81.5-198.5T480-760q117 0 198.5 81.5T760-480q0 117-81.5 198.5T480-200Z'
}
...
export default class Component extends defineElement({
  ...
  setup() {
    ...
    return {
      watches: {
        type: (value) => path.target.setAttribute('d', svgData[value]),
        d: (value) => path.target.setAttribute('d', value)
      },
      render: () => html`
        <style>${style}</style>
        <slot>
